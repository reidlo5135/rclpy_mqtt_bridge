...
def mqtt_bridge_node():
    ros_node_name : str = 'rclpy_mqtt_bridge_node'
    ...
    mqtt_client_factory_name = mqtt_node.get_parameter_or("~mqtt_client_factory", ".mqtt_client:default_mqtt_client_factory")
